...
[t,y]=ode15s(@calculate,[a b],[y1_0 y2_0 x1_0 x2_0]);

toc
    P_t1=y(:,1)-Cal1.K21*(Cal1.K1*u_b.u_b1)^1.3;
    P_t2=y(:,2)-Cal1.K22*(Cal1.K1*u_b.u_b2)^1.3;
    
subplot(3,1,1);
p1=plot(t,y(:,1),t,y(:,2));grid on;p1(1).LineWidth=2;p1(2).LineWidth=2;
title('13:00--14:00');
% title('19:00--20:00');
ylabel('Pd/Mpa'),legend('Boiler 1','Boiler 2');
subplot(3,1,2);
p2=plot(t,P_t1,t,P_t2);grid on;p2(1).LineWidth=2;p2(2).LineWidth=2;
ylabel('Pt/Mpa'),legend('Turbine 1','Turbine 2');
subplot(3,1,3);
p3=plot(t,y(:,3),t,y(:,4));grid on;p3(1).LineWidth=2;p3(2).LineWidth=2;
...
result=[vpa(d_P_d1,5);vpa(d_P_d2,5);vpa(d_N_E1,5);vpa(d_N_E2,5)];
end

function dydt=calculate(t,y)
...
u_b=Calculat_ub(Q_B,Q_C,k_c,k_b);
    ...
    dydt=double([d_P_d1;d_P_d2;d_N_E1;d_N_E2]);
end
